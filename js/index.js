...
/***/ function(module, exports, __webpack_require__) {
	...
	$('#enter').tap(function(){
	  ...
	  $.post('http://1.601819456.applinzi.com/mock/skill.json',{},function(response){
	    var html = '';
	...
	var mySwiper = new Swiper ('.swiper-container', {
	  ...
	  $('#footer div').eq(1).tap(function(){
	     $('#footer div').css({'background':'#444','color':'#fff'})
	      $(this).css({'background':'#e9e9e9','color':'#31B020'}) 
	    $.post('http://1.601819456.applinzi.com/mock/project.json',{},function(response){
	      var html = '';
	      for(var i=0;i<response.length;i++){
	  ...
	  $('#footer div').eq(2).tap(function(){
	     $('#footer div').css({'background':'#444','color':'#fff'})
	      $(this).css({'background':'#e9e9e9','color':'#31B020'})  
	    $.post('http://1.601819456.applinzi.com/mock/work.json',{},function(response){
	      var html = '';
	      for(var i=0;i<response.length;i++){
	  ...
	  $('#footer div').eq(3).tap(function(){
	     $('#footer div').css({'background':'#444','color':'#fff'})
	      $(this).css({'background':'#e9e9e9','color':'#31B020'})   
	    $.post('http://1.601819456.applinzi.com/mock/interest.json',{},function(response){
	      var html = '';
	      for(var i=0;i<response.length;i++){
	  ...
	  $('#footer div').eq(4).tap(function(){
	     $('#footer div').css({'background':'#444','color':'#fff'})
	      $(this).css({'background':'#e9e9e9','color':'#31B020'})   
	    $.post('http://1.601819456.applinzi.com/mock/myself.json',{},function(response){
	      var html = '';
	      for(var i=0;i<response.length;i++){
